    ...
    def load_or_create_profile(self, username):
        ...
        if os.path.exists(profile_path):
            with open(profile_path, 'r') as f:
                return json.load(f), False  # Return profile and is_new_user=False
        else:
            print("Creating a new profile...")
            new_profile = {}  # Or whatever default structure you want
            return new_profile, True  # Return new profile and is_new_user=True
