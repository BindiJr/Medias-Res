...
required_columns = ['title', 'overview', 'genre_1', 'genre_2', 'genre_3', 'genre_4', 'genre_5', 'genre_6', 'vote_average', 'popularity', 'actor_1', 'actor_2', 'actor_3', 'actor_4', 'actor_5', 'actor_6', 'producer_1', 'producer_2', 'producer_3']
...
# Preprocess Textual Data (e.g., Overview)
...
def clean_and_extract_columns(df):
    ...
    # Fill missing budget and revenue with 0 (or you can choose a different default value)
...
# Convert the list of genres into a binary format (one-hot encoding)
...
combined_features = np.hstack([overview_matrix.toarray(), genres_matrix, actors_matrix, producers_matrix, numerical_data])
...
# Example: Recommend top 5 similar movies to the first movie (index 0)
movie_index = 0  # Change this index for other movies in the dataset
