...
# Adjusted: Give more weight to textual features (overview)
overview_weight = 2
combined_features = np.hstack([overview_weight * overview_matrix.toarray(), genres_matrix, actors_matrix, producers_matrix, numerical_data])
