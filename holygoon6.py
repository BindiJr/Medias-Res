...
required_columns = ['title', 'overview', 'genre_1', 'genre_2', 'genre_3', 'genre_4', 'genre_5', 'genre_6', 'vote_average', 'popularity', 'actor_1', 'actor_2', 'actor_3', 'actor_4', 'actor_5', 'actor_6', 'producer_1', 'producer_2', 'producer_3', 'tagline', 'keywords', 'original_language', 'collection_name']
...
# Preprocess Textual Data (e.g., Overview, Tagline, Keywords)
# Fill NaN values with empty string for text-based columns
vectorizer = TfidfVectorizer(stop_words='english', max_features=1000)

# Preprocess 'overview', 'tagline', and 'keywords'
...
# Function to handle missing values and clean up actor/producer/genre/collection columns
...
# Combine numerical features like vote_average, popularity, budget, and revenue
...
combined_features = np.hstack([overview_matrix.toarray(), tagline_matrix.toarray(), keywords_matrix.toarray(), genres_matrix, actors_matrix, producers_matrix, df[['same_collection']].values, numerical_data])
...
# Ask user for a movie index and recommend similar movies
movie_title = input("Enter a movie title to find similar films: ")
...
print(f"Movies similar to '{df.iloc[movie_index]['title']}':")
